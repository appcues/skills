...
| `selector-check/` | Every published tooltip and pin selector: live miss rate, whether the current source tree still matches it, and a stable replacement; run from inside the web app's repo before a deploy |
